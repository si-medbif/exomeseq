...
def make_BQSR(args, db):
    ...
    with open(script_file, 'w') as fout:
        ...
        fout.write('##-------------\n')
        fout.write('docker run --rm -v /:/data alexcoppe/gatk ')
...
def make_annotate(args, db):
    ...
    with open(script_file, 'w') as fout:
        ...
        fout.write('\n\n')
        fout.write('echo "1/6 dbSNP Annotation Completed"\n')
        fout.write('##-------------\n')
        ...
        fout.write('\n\n')
        fout.write('echo "2/6 dbNSFP Annotation Completed"\n')
        fout.write(' ##-------------\n')
        ...
        fout.write('\n\n')
        fout.write('echo "3/6 gwasCat Annotation Completed"\n')
        fout.write('##-------------\n')
        ...
        fout.write('\n\n')
        fout.write('echo "4/6 PhastCons Annotation Completed"\n')
        fout.write('##-------------\n')
        ...
        fout.write('\n\n')
        fout.write('echo "5/6 ClinVar Annotation Completed"\n')
        fout.write('##-------------\n')
        ...
        fout.write('\n\n')
        fout.write('echo "6/6 SnpEff Annotation Completed"\n')
        fout.write('##-------------\n')
